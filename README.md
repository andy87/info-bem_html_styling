...
- **Отсутствие привязка к тегу**.  
  SEO'шники и т.п. сколь угодно часто могут просить менять тэги с DIV на SPAN, с NAV на DIV. 
...
- **отсутствие перегружености классов**  
  По сути у элемента может быть максимум 2 класса
...
- **Удобство разработки адаптива.**  
  Для создания адаптива перезатираются свойства единственного класса  
  Автодополнение/Поиск/Рефакторинг в IDE  
...
хотя это общяя проблема.

-----  

**Пример основных имён элементов:**  
